        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div className="flex justify-end space-x-3 pt-6 border-t-2 border-green-200">
            <button
              type="button"
              onClick={onClose}
              className="rounded-lg border-2 border-green-300 px-6 py-2.5 text-sm font-semibold text-primary-700 transition-all hover:bg-green-50 hover:border-primary-400"
            >
              Cancel
            </button>
            <button
              type="submit"
              disabled={saving}
              className="rounded-lg bg-primary-600 px-8 py-2.5 text-sm font-semibold text-white shadow-lg transition-all hover:bg-primary-700 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {saving ? (
