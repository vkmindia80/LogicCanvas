  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-lg font-semibold text-gray-800">Data Transformations</h3>
      ...
      <div className="space-y-3">
        {transformations.length === 0 ? (
          <div className="text-center py-12 bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
            ...
            <p className="text-gray-600 mb-2">No transformations added yet</p>
            <p className="text-sm text-gray-500">Click "Add Step" to start building your transformation pipeline</p>
          </div>
        ) : (
              ...
              <div key={transform.id} className="bg-white border border-gray-200 rounded-lg p-4 shadow-sm">
                <div className="flex items-start justify-between mb-3">
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <div className="font-medium text-gray-900">{transform.function}</div>
                      <div className="text-xs text-gray-500">{funcInfo.description}</div>
                    </div>
                  </div>
                  <div className="flex items-center gap-2">
                    <button
      ...
      {showPreview && testResult && (
        <div className="mt-4 bg-gray-50 border border-gray-200 rounded-lg p-4">
          ...
          {testResult.success ? (
            <div className="space-y-3">
              <div>
                <div className="text-sm font-medium text-gray-700 mb-1">Final Output:</div>
