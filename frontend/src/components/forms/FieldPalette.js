  ...
  return (
    <div className="w-72 bg-white border-r border-slate-200 overflow-y-auto">
      <div className="p-4 border-b border-slate-200">
        <h3 className="font-semibold text-slate-900">Field Types</h3>
        <p className="text-xs text-slate-500 mt-1">Drag or click to add fields</p>
      </div>
              ...
              {fields.map((field) => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-center space-x-3 p-3 bg-slate-50 hover:bg-primary-50 hover:border-primary-300 border-2 border-slate-200 rounded-lg transition-all group cursor-pointer"
