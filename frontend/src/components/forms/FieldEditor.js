...
const FieldEditor = ({ field, onUpdate, onClose, allFields }) => {
  ...
  return (
    <div className="w-96 bg-white border-l border-green-200 overflow-y-auto">
      {/* Header */}
      <div className="p-4 border-b border-green-200 flex justify-between items-center sticky top-0 bg-white z-10">
        <h3 className="font-semibold text-primary-900">Field Properties</h3>
        <button
          onClick={onClose}
      ...
      <div className="p-4 space-y-6">
        ...
        <div className="flex items-center justify-between">
          <label className="text-sm font-medium text-primary-700">Required Field</label>
        ...
        {['dropdown', 'multiselect', 'radio'].includes(localField.type) && (
          <div>
            ...
            <div className="space-y-2">
              {(localField.options || []).map((option, index) => (
                <div key={index} className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 border border-green-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              ...
              <button
                onClick={addOption}
                className="w-full flex items-center justify-center space-x-2 px-3 py-2 border-2 border-dashed border-green-300 rounded-lg text-primary-600 hover:border-primary-400 hover:text-primary-600 transition-colors"
        ...
        <div className="border-t border-green-200 pt-4">
          <h4 className="text-sm font-semibold text-primary-900 mb-3">Validation Rules</h4>
          ...
          {['text', 'phone'].includes(localField.type) && (
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-green-300 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-transparent font-mono text-sm"
                placeholder="^[a-zA-Z]+$"
              />
            </div>
          )}
        ...
        <div className="border-t border-green-200 pt-4">
          <div className="flex items-center justify-between mb-3">
            <h4 className="text-sm font-semibold text-primary-900">Conditional Visibility</h4>
            <button
            ...
            <div className="space-y-3 bg-green-50 p-3 rounded-lg">
              <div>
                ...
                <select
                  ...
                  className="w-full px-3 py-2 border border-green-300 rounded-lg focus:ring-2 focus:ring-primary-500"
