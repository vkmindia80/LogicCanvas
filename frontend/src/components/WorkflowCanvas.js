...
const nodeTypes = {
  // All node types use EnhancedCustomNode component for better visualization
  start: EnhancedCustomNode,
  end: EnhancedCustomNode,
  task: EnhancedCustomNode,
  form: EnhancedCustomNode,
  screen: EnhancedCustomNode,
  wait: EnhancedCustomNode,
  decision: EnhancedCustomNode,
  switch: EnhancedCustomNode,
  assignment: EnhancedCustomNode,
  loop_for_each: EnhancedCustomNode,
  loop_while: EnhancedCustomNode,
  loop_repeat: EnhancedCustomNode,
  approval: EnhancedCustomNode,
  create_record: EnhancedCustomNode,
  update_record: EnhancedCustomNode,
  delete_record: EnhancedCustomNode,
  lookup_record: EnhancedCustomNode,
  query_records: EnhancedCustomNode,
  get_record: EnhancedCustomNode,
  transform: EnhancedCustomNode,
  filter: EnhancedCustomNode,
  sort: EnhancedCustomNode,
  aggregate: EnhancedCustomNode,
  calculate: EnhancedCustomNode,
  parallel: EnhancedCustomNode,
  merge: EnhancedCustomNode,
  subprocess: EnhancedCustomNode,
  action: EnhancedCustomNode,
  api_call: EnhancedCustomNode,
  webhook: EnhancedCustomNode,
  email: EnhancedCustomNode,
  timer: EnhancedCustomNode,
  event: EnhancedCustomNode,
  error_handler: EnhancedCustomNode,
  // New enhanced node types
  try_catch: EnhancedCustomNode,
  retry: EnhancedCustomNode,
  batch_process: EnhancedCustomNode,
  comment: EnhancedCustomNode,
  milestone: EnhancedCustomNode,
};
