  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="relative h-[90vh] w-[90vw] rounded-xl bg-white shadow-2xl">
        {/* Header */}
        <div className="flex items-center justify-between border-b border-gray-200 bg-gradient-to-r from-primary-500 to-primary-600 px-6 py-4 text-white">
          ...
          {loading ? (
            ...
            <div className="flex h-full items-center justify-center">
              <div className="text-center">
                ...
                <p className="mt-4 text-lg font-medium text-gray-900">No variables found</p>
                      ...
                      <td className="px-4 py-3">
                        <div className="flex space-x-2">
                          <button
                            ...
                            className="rounded p-1 text-gray-600 hover:bg-gray-100 hover:text-primary-600"
                            title="View History"
                          >
          ...
          <div className="absolute inset-0 z-10 flex items-center justify-center bg-black/50 backdrop-blur-sm">
            <div className="w-2/3 max-h-[80vh] overflow-auto rounded-xl bg-white shadow-2xl">
              <div className="sticky top-0 flex items-center justify-between border-b border-gray-200 bg-white px-6 py-4">
                <div>
                  <h3 className="text-lg font-bold text-gray-900">Variable History</h3>
