  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <div className="flex items-center justify-between mb-4">
        <h3 className="text-lg font-semibold text-primary-800">Workflow Triggers</h3>
        <button
          ...
          <div className="space-y-3">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="bg-green-300 text-primary-700 px-4 py-2 rounded-lg hover:bg-green-400"
              >
                Cancel
              </button>
            </div>
      ...
      {loading ? (
        <div className="text-center py-8 text-green-500">Loading triggers...</div>
      ) : triggers.length === 0 ? (
        ...
        <div className="space-y-3">
          {triggers.map((trigger) => (
            <div
              key={trigger.id}
              className="flex items-center justify-between p-3 border border-green-200 rounded-lg hover:border-green-300 transition-colors"
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  {trigger.trigger_type === 'scheduled' && (
                    <div className="text-sm text-primary-600">Cron: {trigger.config.cron}</div>
                  )}
                  {trigger.trigger_type === 'webhook' && trigger.config.webhook_url && (
                    <div className="text-xs text-primary-600 font-mono bg-green-100 px-2 py-1 rounded mt-1">
              ...
              <button
                ...
                className="text-gold-500 hover:text-gold-700 p-2"
