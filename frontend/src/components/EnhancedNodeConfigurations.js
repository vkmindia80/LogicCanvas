...
export const DataOperationConfig = ({ 
  ...
  return (
    <div className="bg-white border-2 border-emerald-200 rounded-lg p-4 shadow-sm space-y-4">
      <h3 className="section-header font-bold text-primary-900 text-sm mb-3 flex items-center space-x-2">
      ...
      <div>
        <label className="block text-sm font-semibold text-primary-700 mb-2">
          Collection/Table Name <span className="text-gold-500">*</span>
        </label>
        <input
          type="text"
          value={collection}
          ...
          className="w-full px-3 py-2 border-2 border-green-200 rounded-lg focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm"
          data-testid="collection-input"
        />
        <p className="text-xs text-green-500 mt-1">The database collection or table to operate on</p>
      </div>
      ...
      {(isUpdate || isDelete || isGet) && (
        <div>
          <label className="block text-sm font-semibold text-primary-700 mb-2">
            Record ID <span className="text-gold-500">*</span>
          </label>
          <input
            type="text"
            value={recordId}
          ...
          />
          <p className="text-xs text-green-500 mt-1">Use ${'{'} variable{'}'} for dynamic IDs from workflow</p>
        </div>
      )}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    ...
                    min="1"
                    max="10000"
                    className="w-full px-3 py-2 border-2 border-green-200 rounded-lg focus:ring-2 focus:ring-emerald-500 text-sm"
    ...
    <div className="bg-white border-2 border-lime-200 rounded-lg p-4 shadow-sm space-y-4">
      ...
      {isSort && (
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-sm font-semibold text-primary-700 mb-2">
              Sort By Field <span className="text-gold-500">*</span>
            </label>
            <input
              type="text"
              value={sortField}
              ...
              className="w-full px-3 py-2 border-2 border-green-200 rounded-lg focus:ring-2 focus:ring-lime-500 text-sm"
      ...
      {isAggregate && (
        <div className="grid grid-cols-2 gap-3">
          <div>
            <label className="block text-sm font-semibold text-primary-700 mb-2">
              Field to Aggregate <span className="text-gold-500">*</span>
            </label>
            <input
              type="text"
      ...
      {isCalculate && (
        <>
          <div>
            <label className="block text-sm font-semibold text-primary-700 mb-2">
              Formula/Expression <span className="text-gold-500">*</span>
            </label>
            <ExpressionEditor
          ...
          <div>
            <label className="block text-sm font-semibold text-primary-700 mb-2">
              Output Variable Name <span className="text-gold-500">*</span>
            </label>
            <input
              type="text"
            ...
            />
            <p className="text-xs text-green-500 mt-1">The result will be stored in this variable</p>
          </div>
        </>
      )}
    </div>
    ...
    <div className="bg-white border-2 border-gold-200 rounded-lg p-4 shadow-sm space-y-4">
      ...
      {isForEach && (
        <>
          <div>
            <label className="block text-sm font-semibold text-primary-700 mb-2">
              Collection Variable <span className="text-gold-500">*</span>
            </label>
            <input
              type="text"
              ...
              className="w-full px-3 py-2 border-2 border-green-200 rounded-lg focus:ring-2 focus:ring-gold-500 text-sm"
              data-testid="loop-collection"
            />
            <p className="text-xs text-green-500 mt-1">The array or collection to iterate over</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              />
              <p className="text-xs text-green-500 mt-1">Access current item as ${loopItemVar}</p>
            </div>
            <div>
              <label className="block text-sm font-medium text-primary-700 mb-1">
                Index Variable Name
              ...
              />
              <p className="text-xs text-green-500 mt-1">Access index as ${loopIndexVar}</p>
            </div>
          </div>
        </>
      )}
      ...
      {(isWhile || isDoWhile) && (
        <div>
          <label className="block text-sm font-semibold text-primary-700 mb-2">
            {isWhile ? 'While Condition' : 'Do-While Condition'} <span className="text-gold-500">*</span>
          </label>
          <ExpressionEditor
      ...
      {isRepeat && (
        <div>
          <label className="block text-sm font-semibold text-primary-700 mb-2">
            Repeat Count <span className="text-gold-500">*</span>
          </label>
          <input
            type="number"
            value={repeatCount}
          ...
          />
          <p className="text-xs text-green-500 mt-1">Number of times to repeat the loop</p>
        </div>
      )}
      ...
      <div>
        ...
        />
        <p className="text-xs text-green-500 mt-1">Loop will stop after this many iterations to prevent infinite loops</p>
      </div>
      ...
      <div className="border-t-2 border-gold-100 pt-4 space-y-4">
        ...
        {isForEach && (
          <div>
            ...
            />
            <p className="text-xs text-green-500 mt-1">Process items in batches for better performance (0 = no batching)</p>
          </div>
        )}
        ...
        <div>
          ...
          />
          <p className="text-xs text-green-500 mt-1">Exit loop early when condition becomes true</p>
        </div>
        ...
        {(isWhile || isDoWhile) && (
          <div>
            ...
            />
            <p className="text-xs text-green-500 mt-1">Track loop iterations in a variable</p>
          </div>
        )}
  ...
  return (
    <div className="bg-white border-2 border-gold-200 rounded-lg p-4 shadow-sm space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="section-header font-bold text-primary-900 text-sm flex items-center space-x-2">
      ...
      {assignments.length === 0 ? (
        <div className="text-center py-6 bg-green-50 border-2 border-dashed border-green-200 rounded-lg">
          <p className="text-sm text-green-500 mb-2">No assignments configured</p>
          <button
            onClick={addAssignment}
        ...
        <div className="space-y-3">
          {assignments.map((assignment, index) => (
            <div key={index} className="grid grid-cols-12 gap-2 items-start p-3 bg-green-50 rounded-lg border border-green-200">
              <div className="col-span-5">
                <label className="text-xs font-medium text-primary-600 mb-1 block">Variable</label>
                <input
                  type="text"
              ...
              <div className="col-span-6">
                <label className="text-xs font-medium text-primary-600 mb-1 block">Value/Expression</label>
                <input
                  type="text"
              ...
              <div className="col-span-1 pt-6">
                <button
                  ...
                  className="p-1.5 text-gold-600 hover:bg-gold-50 rounded"
                  title="Remove"
                >
...
export const EmailConfig = ({ emailTo, setEmailTo, emailSubject, setEmailSubject, emailBody, setEmailBody, emailTemplate, setEmailTemplate }) => {
  return (
    <div className="bg-white border-2 border-gold-200 rounded-lg p-4 shadow-sm space-y-4">
      ...
      <div>
        <label className="block text-sm font-semibold text-primary-700 mb-2">
          To (Recipients) <span className="text-gold-500">*</span>
        </label>
        <input
          type="text"
          value={emailTo}
        ...
        />
        <p className="text-xs text-green-500 mt-1">Separate multiple emails with commas</p>
      </div>
      ...
      <div>
        <label className="block text-sm font-semibold text-primary-700 mb-2">
          Body <span className="text-gold-500">*</span>
        </label>
        <textarea
          value={emailBody}
          ...
          className="w-full px-3 py-2 border-2 border-green-200 rounded-lg focus:ring-2 focus:ring-gold-500 text-sm resize-none"
          data-testid="email-body"
        />
        <p className="text-xs text-green-500 mt-1">Use ${'{'} variable{'}'} to insert dynamic content</p>
      </div>
...
export const WaitConfig = ({ waitForEvent, setWaitForEvent, waitCondition, setWaitCondition, workflowVariables }) => {
  return (
    <div className="bg-white border-2 border-green-300 rounded-lg p-4 shadow-sm space-y-4">
      <h3 className="section-header font-bold text-primary-900 text-sm mb-3 flex items-center space-x-2">
      ...
      <div className="bg-green-50 border border-green-300 rounded-lg p-3 mb-4">
        <p className="text-xs text-primary-700 flex items-start space-x-2">
          <Info className="w-4 h-4 mt-0.5 flex-shrink-0" />
      ...
      <div>
        ...
        <input
          ...
          className="w-full px-3 py-2 border-2 border-green-200 rounded-lg focus:ring-2 focus:ring-green-500 text-sm"
    ...
    <div className="bg-white border-2 border-sky-200 rounded-lg p-4 shadow-sm space-y-4">
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full px-3 py-2 border-2 border-green-200 rounded-lg focus:ring-2 focus:ring-sky-500 text-sm resize-none"
          data-testid="screen-content"
        />
        <p className="text-xs text-green-500 mt-1">Use ${'{'} variable{'}'} to display dynamic values</p>
      </div>
      ...
      <div>
        ...
        <select
          ...
          className="w-full px-3 py-2 border-2 border-green-200 rounded-lg focus:ring-2 focus:ring-sky-500 text-sm"
...
export const ErrorHandlerConfig = ({ errorHandlerType, setErrorHandlerType, errorHandlerAction, setErrorHandlerAction }) => {
  return (
    <div className="bg-white border-2 border-gold-300 rounded-lg p-4 shadow-sm space-y-4">
      <h3 className="section-header font-bold text-primary-900 text-sm mb-3 flex items-center space-x-2">
...
export const SwitchConfig = ({ switchVariable, setSwitchVariable, switchCases, setSwitchCases, workflowVariables }) => {
  ...
  return (
    <div className="bg-white border-2 border-amber-200 rounded-lg p-4 shadow-sm space-y-4">
      ...
      <div>
        <label className="block text-sm font-semibold text-primary-700 mb-2">
          Switch Variable <span className="text-gold-500">*</span>
        </label>
        <input
          type="text"
          ...
          className="w-full px-3 py-2 border-2 border-green-200 rounded-lg focus:ring-2 focus:ring-amber-500 text-sm"
      ...
      <div>
        ...
        {switchCases.length === 0 ? (
          <div className="text-center py-4 bg-green-50 border-2 border-dashed border-green-200 rounded-lg">
            <p className="text-sm text-green-500 mb-2">No cases defined</p>
            <button
              onClick={addCase}
          ...
          <div className="space-y-2">
            {switchCases.map((caseItem, index) => (
              <div key={index} className="grid grid-cols-12 gap-2 items-start p-2 bg-green-50 rounded border border-green-200">
                <div className="col-span-5">
                  <input
                    type="text"
  ...
  return (
    <div className={`bg-white border-2 ${isBreak ? 'border-rose-200' : 'border-pink-200'} rounded-lg p-4 shadow-sm space-y-4`}>
      ...
      <div className={`${isBreak ? 'bg-rose-50 border-rose-200' : 'bg-pink-50 border-pink-200'} border rounded-lg p-3`}>
        <h4 className="text-xs font-semibold text-primary-700 mb-2">💡 Example Use Cases:</h4>
        <ul className="text-xs text-primary-600 space-y-1 ml-4 list-disc">
          {isBreak && (
            <>
