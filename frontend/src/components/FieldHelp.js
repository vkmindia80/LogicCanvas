    ...
    <div className="mt-1 space-y-2">
      ...
      {example && (
        <div className="text-xs text-slate-600 bg-slate-50 border border-slate-200 rounded-lg p-2">
          ...
          <code className="text-slate-800 bg-white px-1.5 py-0.5 rounded border border-slate-300">
            {example}
          </code>
        </div>
      )}
      ...
      {learnMoreContent && (
        <div className="border border-slate-300 rounded-lg overflow-hidden">
          <button
            ...
            className="w-full flex items-center justify-between px-3 py-2 bg-slate-100 hover:bg-slate-200 transition-colors text-xs font-medium text-slate-700"
          >
          ...
          {showLearnMore && (
            <div className="p-3 bg-white text-xs text-slate-700 space-y-2 border-t border-slate-200">
