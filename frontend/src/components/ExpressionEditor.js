      ...
      {showSuggestions && (
        <div className="bg-gradient-to-br from-green-50 to-green-50 border-2 border-green-200 rounded-xl p-4">
          <div className="flex items-center space-x-2 mb-3">
            ...
            <h4 className="text-sm font-semibold text-green-900">Common Expression Patterns</h4>
          </div>
          <div className="space-y-2">
            {commonExpressions.map((expr, idx) => (
              <button
                ...
                className="w-full text-left p-2 bg-white hover:bg-green-50 rounded-lg border border-green-200 transition-colors group"
              >
          ...
          <div className="flex flex-wrap gap-2">
            {Object.keys(variables).map((varName) => (
              <button
                ...
                className="text-xs bg-white text-green-700 px-3 py-2 rounded-lg border-2 border-green-200 hover:bg-green-50 hover:border-green-400 transition-all font-mono font-semibold shadow-sm hover:shadow-md"
