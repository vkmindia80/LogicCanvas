  ...
  const getHealthColor = (status) => {
    switch (status) {
      ...
      case 'critical':
        return 'text-gold-600 bg-gold-100';
      default:
        return 'text-primary-600 bg-green-100';
    }
  };

  const getUsageColor = (percentage) => {
    if (percentage >= 90) return 'bg-gold-500';
                      ...
                      >
                        <div className="flex items-start justify-between mb-3">
                          ...
                          <button
                            ...
                            disabled={loading}
                            className="px-3 py-1 text-sm text-gold-600 hover:bg-gold-50 rounded transition-colors disabled:opacity-50"
                          >
                            Reset Pool
                          </button>
                        </div>
                        ...
                        <div className="grid grid-cols-4 gap-3 mb-3">
                          ...
                          <div className="bg-green-50 rounded-lg p-2">
                            <div className="text-xs text-green-500">Requests</div>
                            <div className="text-lg font-bold text-primary-900">
                        ...
                        <div>
                          <div className="flex items-center justify-between mb-1">
                            <span className="text-xs text-primary-600">Pool Usage</span>
                        ...
                        <div className="mt-3 pt-3 border-t grid grid-cols-3 gap-2 text-xs">
                          <div className="flex items-center gap-1">
                            ...
                            <span className="text-primary-600">Avg Latency:</span>
                          ...
                          <div className="flex items-center gap-1">
                            <AlertCircle size={12} className="text-gold-600" />
                        ...
                        {pool.health_status === 'critical' && (
                          <div className="mt-3 p-2 bg-gold-50 border border-gold-200 rounded-lg">
                            <div className="flex items-start gap-2">
                              <AlertCircle size={14} className="text-gold-600 mt-0.5" />
