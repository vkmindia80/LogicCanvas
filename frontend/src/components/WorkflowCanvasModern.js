  ...
  return (
    <div className="flex h-screen bg-slate-50">
      ...
      {selectedNode && !showExecutionPanel && !showTriggerConfig && (
        <div className="w-80 lg:w-96 xl:w-[400px] h-screen bg-gradient-to-b from-white to-slate-50 border-l border-slate-200 shadow-lg p-4 overflow-y-auto flex-shrink-0 hidden md:block">
          <NodeEditorModern
            node={selectedNode}
            onUpdate={updateNode}
            onDelete={deleteNode}
