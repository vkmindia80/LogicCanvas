  ...
  if (compact) {
    return (
      ...
      >
        ...
        {showDetails && (
          <div className="absolute top-full left-0 mt-2 w-80 bg-white border-2 border-gray-200 rounded-lg shadow-2xl p-4 z-50"
               onClick={(e) => e.stopPropagation()}>
            <div className="flex items-center justify-between mb-3">
              <h4 className="font-bold text-gray-900">Workflow Health</h4>
              <button
            ...
            <div className="space-y-2 mb-4">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className={`font-semibold ${health.metrics.validation_errors > 0 ? 'text-red-600' : 'text-green-600'}`}>
                  {health.metrics.validation_errors}
                </span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">Warnings:</span>
                <span className="font-semibold text-yellow-600">{health.metrics.validation_warnings}</span>
              </div>
            </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4">
          <div className={`text-2xl font-bold ${
            health.metrics.validation_errors > 0 ? 'text-red-600' : 'text-green-600'
          }`}>
            {health.metrics.validation_errors}
          </div>
          <div className="text-xs text-gray-500">Validation Errors</div>
        </div>
        <div className="bg-gray-50 rounded-lg p-4">
