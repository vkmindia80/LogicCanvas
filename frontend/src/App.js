...
const AppShell = () => {
    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-primary-950 via-primary-900 to-primary-950">
        <div className="text-center text-white">
          ...
          <p className="text-sm text-green-100">Warming up LogicCanvas services…</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex min-h-screen bg-white">
      {/* Left Sidebar */}
      <aside
        className="fixed left-0 top-0 z-40 h-screen w-72 bg-gradient-to-b from-primary-900 via-primary-800 to-primary-900 shadow-2xl transition-all duration-300 flex flex-col hidden lg:block"
      >
        {/* Logo Section */}
        <div className="flex h-16 items-center justify-between border-b border-primary-700 px-4 flex-shrink-0">
          <div className="flex items-center space-x-3">
            <div className="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-gold-500 to-gold-700 shadow-lg">
            ...
            <ReactFlowProvider>
              <div className="relative">
                <button
                  ...
                  className="absolute left-4 top-4 z-10 flex items-center space-x-2 rounded-xl border border-slate-300 bg-white px-4 py-2.5 text-slate-700 shadow-lg hover:shadow-xl transition-all hover:bg-slate-50 hover:border-indigo-300 font-medium"
