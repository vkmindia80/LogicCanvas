...
export const cardStyles = {
  base: 'bg-white rounded-xl border-2 border-green-200 shadow-lg transition-all',
  hover: 'hover:border-primary-300 hover:shadow-xl hover:shadow-primary-500/10',
  padding: 'p-6',
  header: 'font-semibold text-primary-900 text-lg mb-4',
};
...
export const buttonStyles = {
  ...
  secondary: 'inline-flex items-center justify-center space-x-2 rounded-xl border-2 border-green-300 bg-white px-6 py-3 text-sm font-semibold text-primary-700 shadow-sm transition-all hover:bg-green-50 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed',
  ...
  danger: 'inline-flex items-center justify-center space-x-2 rounded-xl bg-gold-500 px-6 py-3 text-sm font-semibold text-white shadow-lg transition-all hover:bg-gold-600 hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed',
  
  ghost: 'inline-flex items-center justify-center space-x-2 rounded-xl px-4 py-2 text-sm font-medium text-primary-600 transition-all hover:bg-green-100 hover:text-primary-900',
...
export const inputStyles = {
  base: 'w-full rounded-xl border-2 border-green-200 bg-white px-4 py-3 text-sm font-medium text-primary-900 placeholder:text-green-400 transition-all focus:border-primary-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-500/20',
  error: 'border-gold-300 focus:border-gold-500 focus:ring-gold-500/20',
...
export const badgeStyles = {
  ...
  rejected: 'inline-flex items-center space-x-1 rounded-full border-2 border-gold-300 bg-gold-100 px-3 py-1 text-xs font-semibold text-gold-800',
  paused: 'inline-flex items-center space-x-1 rounded-full border-2 border-green-300 bg-green-100 px-3 py-1 text-xs font-semibold text-primary-800',
  archived: 'inline-flex items-center space-x-1 rounded-full border-2 border-green-300 bg-green-100 px-3 py-1 text-xs font-semibold text-primary-800',
  ...
  inactive: 'inline-flex items-center space-x-1 rounded-full border-2 border-green-300 bg-green-100 px-3 py-1 text-xs font-semibold text-primary-800',
  error: 'inline-flex items-center space-x-1 rounded-full border-2 border-gold-300 bg-gold-100 px-3 py-1 text-xs font-semibold text-gold-800',
  ...
  urgent: 'inline-flex items-center space-x-1 rounded-full border-2 border-gold-300 bg-gold-100 px-3 py-1 text-xs font-semibold text-gold-800 animate-pulse',
  ...
  low: 'inline-flex items-center space-x-1 rounded-full border-2 border-green-300 bg-green-100 px-3 py-1 text-xs font-semibold text-primary-800',
};
...
export const statsCardStyles = {
  base: 'rounded-xl border-2 border-green-200 bg-white p-6 shadow-lg transition-all hover:shadow-xl',
  value: 'text-3xl font-bold text-primary-900',
  label: 'text-sm font-medium text-primary-600 mb-2',
  change: 'text-sm text-green-500 mt-1',
};
...
export const modalOverlayStyles = {
  base: 'fixed inset-0 z-50 flex items-center justify-center bg-primary-900/50 backdrop-blur-sm p-4',
...
export const sidebarStyles = {
  base: 'bg-gradient-to-b from-primary-900 via-primary-800 to-primary-900 shadow-2xl',
  ...
  itemInactive: 'text-green-300 hover:bg-primary-700/50 hover:text-white',
  divider: 'border-t border-primary-700',
};
...
export const tableStyles = {
  wrapper: 'bg-white rounded-xl border-2 border-green-200 overflow-hidden shadow-lg',
  header: 'bg-green-50 border-b-2 border-green-200',
  headerCell: 'px-6 py-4 text-left text-xs font-semibold text-primary-700 uppercase tracking-wider',
  row: 'border-b border-green-200 hover:bg-green-50 transition-colors',
  cell: 'px-6 py-4 text-sm text-primary-900',
};
...
export const searchBarStyles = {
  ...
  input: 'w-full rounded-xl border-2 border-green-200 bg-green-50 py-3 pl-12 pr-4 text-sm font-medium placeholder:text-green-400 focus:border-primary-500 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-500/20',
  icon: 'absolute left-4 top-1/2 h-5 w-5 -translate-y-1/2 transform text-green-400',
};
...
export const emptyStateStyles = {
  ...
  icon: 'w-16 h-16 text-green-400',
  title: 'mb-3 text-2xl font-bold text-primary-900',
  description: 'mb-6 max-w-md text-base text-primary-600 leading-relaxed',
};
...
export const toastStyles = {
  ...
  error: 'bg-gold-50 border-gold-300 text-gold-900',
...
export const priorityColors = {
  low: { bg: 'bg-green-100', text: 'text-primary-700', border: 'border-green-300' },
  ...
  urgent: { bg: 'bg-gold-100', text: 'text-gold-700', border: 'border-gold-300' },
};
